...
(def outbound-param
  {
   ...
   "qid" "1"
   "format" "saveToFile"
   "filters" "SCIELO_COLLECTION AUTHORSIDENTIFIERS ACCESSION_NUM ISSN SOURCE TITLE AUTHORS"
   ;"mark_from" "1"
   ;"mark_to" "10"
   ;"incitesCount" "36776"
   ...
   "fields_selection" "SCIELO_COLLECTION AUTHORSIDENTIFIERS ACCESSION_NUM ISSN SOURCE TITLE AUTHORS"
