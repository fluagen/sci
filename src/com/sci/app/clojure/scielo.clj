...
(def outbound-param
  {
   ...
   "qid" "1"
   "format" "saveToFile"
   "filters" "SCIELO_COLLECTION USAGEIND AUTHORSIDENTIFIERS PUBINFO ACCESSION_NUM SUBJECT_CATEGORY SCIELO_CATEGORY ISSN CITTIMES CITREFC CITREF ADDRS ABSTRACT KEYWORDS DOCTYPE LANG SOURCE TITLE AUTHORS"
   ;"mark_from" "1"
   ;"mark_to" "10"
   ;"incitesCount" "36776"
   ...
   "fields_selection" "SCIELO_COLLECTION USAGEIND AUTHORSIDENTIFIERS PUBINFO ACCESSION_NUM SUBJECT_CATEGORY SCIELO_CATEGORY ISSN CITTIMES CITREFC CITREF ADDRS ABSTRACT KEYWORDS DOCTYPE LANG SOURCE TITLE AUTHORS"
