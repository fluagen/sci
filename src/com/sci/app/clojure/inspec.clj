...
(def outbound-param
  {
   ...
   "qid" "1"
   "format" "saveToFile"
   "filters" "USAGEIND AUTHORSIDENTIFIERS SUBJECT_CATEGORY IPC IMAGES DOCTYPE PUBINFO ACCESSION_NUM NUM_OF_REF LANG CLASSIFICATION_CODES DESCRIPTORS IDENTIFYING_CODES ABSTRACT UNCONTROLLED_TERMS CONTROLLED_TERMS SPONSORS TRANSLATORS TREATMENT ADDRESS CONFERENCE_INFO PATENT_INFO SOURCE TITLE INVENTORS_ASSIGNEES AUTHORS_EDITORS"
   ;"mark_from" "1"
   ;"mark_to" "10"
   ;"incitesCount" "36776"
   ...
   "fields_selection" "USAGEIND AUTHORSIDENTIFIERS SUBJECT_CATEGORY IPC IMAGES DOCTYPE PUBINFO ACCESSION_NUM NUM_OF_REF LANG CLASSIFICATION_CODES DESCRIPTORS IDENTIFYING_CODES ABSTRACT UNCONTROLLED_TERMS CONTROLLED_TERMS SPONSORS TRANSLATORS TREATMENT ADDRESS CONFERENCE_INFO PATENT_INFO SOURCE TITLE INVENTORS_ASSIGNEES AUTHORS_EDITORS"
